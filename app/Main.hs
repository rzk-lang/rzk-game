...
viewModel :: GameEnv -> Model -> View context props Model Action
viewModel env m =
  H.div_ []
...
editLink :: GameEnv -> T.Text -> View context props Model Action
...
gameFooter :: GameEnv -> View context props Model Action
...
importBanner :: Model -> View context props Model Action
...
navHeader :: GameEnv -> Model -> View context props Model Action
navHeader env m =
...
helpLink :: GameEnv -> View context props Model Action
...
levelMap :: GameEnv -> Model -> View context props Model Action
levelMap env m =
...
progressControls :: Model -> View context props Model Action
progressControls m =
...
slotButton :: GameEnv -> Model -> (Int, Slot) -> View context props Model Action
...
icoLock :: View context props Model Action
...
-- "must do" denominator.
extrasBadge :: (Int, Int) -> [View context props Model Action]
extrasBadge (_, 0)   = []
extrasBadge (xd, xt) =
...
breadcrumb :: GameEnv -> Model -> T.Text -> View context props Model Action
...
proseSlotView :: GameEnv -> Model -> T.Text -> Prose -> [View context props Model Action]
...
puzzleSlotView :: GameEnv -> Model -> T.Text -> Int -> PuzzleItem -> [View context props Model Action]
...
typingBadge :: View context props Model Action
typingBadge =
...
pretestControls :: GameEnv -> Model -> PuzzleItem -> [View context props Model Action]
pretestControls env m z
...
lockPanel :: GameEnv -> Model -> PuzzleItem -> View context props Model Action
lockPanel env m z =
...
remedyBox :: GameEnv -> T.Text -> [Remedy] -> View context props Model Action
...
remedyLink :: GameEnv -> Remedy -> View context props Model Action
...
sectionDoneBadge :: GameEnv -> Model -> T.Text -> View context props Model Action
sectionDoneBadge env m sid
...
intersperseNewlines :: [View context props Model Action] -> [View context props Model Action]
...
preludeView :: Model -> Level -> View context props Model Action
preludeView m lvl =
...
editorView :: MisoString -> [(Int, Maybe Int)] -> View context props Model Action
...
abbrevView :: Model -> View context props Model Action
...
movesView :: Level -> Model -> View context props Model Action
movesView lvl m =
  case m ^. result of
...
moveButton :: MoveKind -> T.Text -> View context props Model Action
moveButton kind ins =
...
actionBar :: Model -> View context props Model Action
actionBar m =
...
inventoryView :: Level -> View context props Model Action
inventoryView lvl
  ...
  where
    ...
    entryView :: InventoryEntry -> [View context props Model Action]
    entryView e =
...
gateView :: Level -> CheckResult -> [T.Text] -> View context props Model Action
...
forbiddenGateView :: Level -> [T.Text] -> View context props Model Action
...
-- as code, not prose.
gateBox :: Bool -> T.Text -> [T.Text] -> T.Text -> View context props Model Action
...
-- for a gate notice.
monoNames :: [T.Text] -> [View context props Model Action]
monoNames = go
  where
    go []       = []
    go [n]      = [ nameSpan n ]
...
hintsView :: Model -> Level -> View context props Model Action
hintsView m lvl
  | null hs   = text ""
  | otherwise =
...
advanceView :: GameEnv -> Model -> Bool -> View context props Model Action
...
navBar :: GameEnv -> Model -> View context props Model Action
navBar env m =
  H.div_ [ P.class_ "nav" ]
...
-- pointer to it.
checkStatusView :: Model -> View context props Model Action
...
resultView :: GameEnv -> Level -> MisoString -> CheckResult -> View context props Model Action
...
rzkSpans :: T.Text -> [View context props Model Action]
rzkSpans t =
  [ H.span_ [ P.class_ (ms (tokClassName cls)) ] [ text (ms txt) ]
...
conclusionView :: Model -> Level -> Bool -> View context props Model Action
...
holeView :: HoleView -> View context props Model Action
holeView HoleView{..} =
